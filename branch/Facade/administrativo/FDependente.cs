...
namespace Facade.administrativo
{
    public class FDependente
    {
        ...
        ///// <summary>
        ///// Lista a sequnece de dependente
        ///// </summary>
        ...
        //private List<EDependente> ConvertList(ConexaoPostGre conexao)
        //{
        //    List<EDependente> lst = new List<EDependente>();
        //    EDependente contrato;

        //    while (conexao.Reader.Read())
        //    {
        //        contrato = new EDependente();
        //        contrato.IsnDependente = conexao.Reader.GetInt32(0);
        //        contrato.DscParentesco = conexao.Reader.GetString(1);
        //        contrato.FlgAtivo = conexao.Reader.GetBoolean(2);
        //        contrato.Funcionario.IsnFuncionario = new FFuncionario().
