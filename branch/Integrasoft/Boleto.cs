...
namespace dotnetraptors.Brazil.Boleto
{
	...
	public class HTMLBoleto
	{
		...
		public void AddBoleto( Boleto lBoleto, string strLinha, string strCodBarras)
		{
			if( _Encerrado) 
            ...
            lLinhaDigitavel = strLinha.Substring(0,5) + "." + strLinha.Substring(5,5) + " " + strLinha.Substring(10,5) + "." +
                strLinha.Substring(15,6) + " " + strLinha.Substring(21,5) + "." + strLinha.Substring(26,6) + " "
                + strLinha.Substring(32, 1) + " " + strLinha.Substring(33,14);
            lCodigoBarras = strCodBarras;
            lNossoNumero = strLinha.Substring(11, 9) + strLinha.Substring(21, 8);
            ...
            _Buffer.Append("<td class=cp vAlign=bottom align=right><br><br>&nbsp;Ficha de Compensação&nbsp;</td></tr></table>");
            //_Buffer.Append("<div align=center><img src=" + sImgCorte + "></div>");
		}
